...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView, @NonNull ImageView ivBall) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.iv_ball;
      ImageView ivBall = ViewBindings.findChildViewById(rootView, id);
      if (ivBall == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((RelativeLayout) rootView, ivBall);
    }
